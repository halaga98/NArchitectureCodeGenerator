...
public partial class GenerateCrudCliCommand
{
    public class Settings : CommandSettings
    {
        ...
        [CommandArgument(position: 1, template: "[RetailManagementContext]")]
        ...
        public void CheckEntityArgument()
        {
            ...
            string[] entities = Directory
                .GetFiles(path: PlatformHelper.SecuredPathJoin(ProjectPath, "Pars.RM.RetailApi.MobileStoreApi.Data\\DataModel\\RetailManagementContext", "Table"))   //todo buraya entitylerin oldugu kismi goster yada ver commanddan verilen etitiy i al.
            ...
            EntityName = EntityName.Replace("tb_", "");
        }
        ...
        public void CheckDbContextArgument()
        {
            ...
            string[] dbContexts = Directory
                .GetFiles(path: PlatformHelper.SecuredPathJoin(ProjectPath, "Pars.RM.RetailApi.MobileStoreApi.Data", "EF"))
                .Select(Path.GetFileNameWithoutExtension)
                .ToArray()!;
