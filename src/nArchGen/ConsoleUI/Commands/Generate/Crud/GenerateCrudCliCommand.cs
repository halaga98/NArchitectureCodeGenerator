...
public partial class GenerateCrudCliCommand : AsyncCommand<GenerateCrudCliCommand.Settings>
{
    ...
    public override async Task<int> ExecuteAsync(CommandContext context, Settings settings)
    {
      ...
      //  settings.CheckMechanismOptions();
        ...
        string entityPath = PlatformHelper.SecuredPathJoin(settings.ProjectPath, "Pars.RM.RetailApi.MobileStoreApi.Data\\DataModel\\RetailManagementContext", "Table", $"tb_{settings.EntityName}.cs");
